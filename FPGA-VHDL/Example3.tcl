# 
# Project automation script for Example3 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source Example3.tcl), then you can
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/home/ttsiod/Xilinx/KB/ZestSC1/Examples/MandelbrotInVHDL/FPGA-VHDL/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "Example3" -process "Generate IBIS Model"
